...
async def generate_sub_module_documentation(
    ...
    for sub_module_name, core_component_ids in sub_module_specs.items():
        ...
        if is_complex_module(ctx.deps.components, core_component_ids) and ctx.deps.current_depth < ctx.deps.max_depth and num_tokens >= _settings.WIKI_MAX_TOKEN_PER_LEAF_MODULE:
            sub_agent = Agent(
