    ...
    <div className="w-full pt-10 flex flex-col justify-start items-start">
      ...
      <div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
        <div className="h-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8">
          ...
          <div className="text-[rgba(73,66,61,0.90)] text-sm font-medium leading-[18px] font-sans"></div>
        </div>
            ...
            <div className="flex justify-start items-start gap-4">
              ...
              <div className="w-6 h-6 relative overflow-hidden">
                <div className="w-6 h-6 left-0 top-0 absolute flex items-center justify-center">
                  <a href="https://x.com/jenilsavani_">
                    <svg
                      width="16"
                      height="16"
                      viewBox="0 0 24 24"
              ...
              <div className="w-6 h-6 relative overflow-hidden">
                <div className="w-6 h-6 left-0 top-0 absolute flex items-center justify-center">
                  <a href="https://github.com/SecrinLabs/secrin">
                    <svg
                      width="16"
                      height="16"
                      viewBox="0 0 24 24"
